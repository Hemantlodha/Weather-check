...
public class generalQueryIntentHandler  implements RequestHandler {
    @Override
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("general_query"));
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                speechText="The weather condition is: "+ output.substring(ind, end);

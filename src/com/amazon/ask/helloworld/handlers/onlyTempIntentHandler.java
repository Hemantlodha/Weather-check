...
public class onlyTempIntentHandler  implements RequestHandler {
    @Override
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("onlytemp"));
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        if (intent.getSlots() != null) {
            ...
            Slot mySlot1 = slots.get("feature");
            if (mySlot != null && mySlot.getValue() != null) {
                city = mySlot.getValue();
                // Process the slot value as needed
            }
             if (mySlot1 != null && mySlot1.getValue() != null) {
                feature = mySlot1.getValue();
                // Process the slot value as needed
            }
        }
        universalCity=city;
        String speechText="something wrong", repromptText="you can ask any city weather";
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                String feat=feature;
                if("temperature".equalsIgnoreCase(feature))
                {
                    feat="temp";
                }
                 if("wind speed".equalsIgnoreCase(feature))
                {
                    feat="wind_speed";
                }
                // Process the response as needed
                speechText="The "+feature+" of "+ city+ " is " +weatheMap.get(feat);
                count++;
            ...
            repromptText =
                    "You can ask another city weather";
